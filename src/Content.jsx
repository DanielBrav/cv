...
export default class Content extends React.Component {
              ...
              <div className="pre">
                <div className="speech-bubble brightB">
                  ...
                  <div className="aboutWords">
                        My name is Daniel Braverman, I am 26 years old from Ramat Gan, Israel; I am a <b>Full Stack Engineer with a B.Sc in Computer Science 
                        from Ben Gurion University of the Negev. </b>
      ...
      <div className={educationParagraph} ref={this.experienceRef}>
        <div className={educationContent}>
          <div className="eduWords">
            ...
            <br />
            <div className="subTitle">
              <b>University projects (More projects can be seen in GitHub)</b>
            </div>
            <div className="lineItem">
              <div className="expItem" style={{ display: 'flex' }}>
                <div className="theLogo">
  ...
  generateHeader(color) {
    const { location } = this.state; 
    const hide = location === -1 ? "hidden" : "visible";
    const bgColor = "headerBg" + color;
    const logoAndName = classNames("logoAndName", bgColor);
    const slogan = classNames("slogan", color ? "sloganBlackBorder" : "sloganWhiteBorder");
  ...
  */}
  ...
  whichHeader(location) {
    switch(location) {
      case 0: return this.generateHeader(location);
      //case -1: return "";
      default: return this.generateHeader(location);
    }
  }
